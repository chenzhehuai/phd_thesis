...
\begin{figure*}
  \centering
    \includegraphics[width=\linewidth]{figure/pit-example.pdf}
    \caption{\it 50 小时数据集的解码例子，这里比较了所提出的方法与PIT基线的不同性能。上半部分来自A输出，下半部分来自B输出。 C, S, D, I 分别表示：正确，替换错误，删除错误，插入错误。}
    \label{fig:example}
\end{figure*}
